...
public class TicketServiceImplTest {
    ...
    @Test
    public void given_adult_with_infant_purchaseTickets_then_Success() {
    ...
    @Test
    public void given_adult_with_child_purchaseTickets_then_Success() {
    ...
    @Test
    public void given_adult_with_infant_and_child_purchaseTickets_then_Success() {
